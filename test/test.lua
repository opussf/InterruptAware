...
ParseTOC( "../src/InteruptAware.toc" )

test.outFileName = "testOut.xml"

InteruptAwareFrame = CreateFrame()

-- addon setup
function test.before()
end
function test.after()
	for i, log in pairs( InteruptAware_log ) do
...
function test.test_COMBAT_LOG_EVENT_UNFILTERED_01()
	...
	InteruptAware.COMBAT_LOG_EVENT_UNFILTERED( )
end
